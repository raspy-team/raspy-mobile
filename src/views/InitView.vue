    ...
    <div class="oauth-container flex flex-col gap-2 pb-10 w-full max-w-sm">
      ...
      <div class="fixed w-[90%] bottom-10 left-[5%]">
        ...
        <div class="mt-5 text-xs text-gray-600 text-left">
          본 서비스 이용 시
          <span class="text-blue-600 underline cursor-pointer" @click="showTermsModal = true">
            개인정보 이용약관
          </span>
          및
          <span class="text-blue-600 underline cursor-pointer" @click="showPrivacyModal = true">
            개인정보처리방침
          </span>
          에 동의하게 됩니다.
          ...
          >
            <div class="bg-white rounded-2xl shadow-2xl w-[90vw] max-w-md p-6">
              ...
              <div class="max-h-64 overflow-auto text-sm space-y-2">
                ...
                <b>제1조 (목적)</b>
                <br />
                본 약관은 주식회사 래스피(이하 “회사”)가 제공하는 Match 서비스(이하 “서비스”)의
                이용과 관련하여 회사와 이용자 간의 권리, 의무, 책임, 기타 필요한 사항을 규정함을
                목적으로 합니다.
                <br /><br />
                ...
                2. “콘텐츠”란 서비스 내에 게시 또는 업로드된 텍스트, 사진, 이미지 등 일체의 정보를
                의미합니다.
                <br /><br />

                <b>제3조 (이용계약의 체결 및 탈퇴)</b>
                <br />
                1. 서비스의 이용은 카카오/애플 소셜 로그인, 이메일 인증 등 회사가 정한 방식으로
                회원가입 후 가능합니다.<br />
                ...
                <b>제4조 (회원의 의무)</b>
                <br />
                1. 회원은 관계 법령, 본 약관 및 서비스 이용안내 등 회사의 공지사항을 준수해야
                합니다.<br />
                ...
                <br />
                1. 회사는 서비스의 지속적 제공을 위해 최선을 다하나, 운영상·기술상 사유로 일부
                내용이 변경될 수 있습니다.<br />
                2. 회사는 서비스 제공에 있어 필요한 경우 사전 공지 후 서비스의 일부 또는 전부를
                변경, 중단할 수 있습니다.
                <br /><br />

                <b>제6조 (게시물 및 저작권)</b>
                <br />
                1. 회원이 서비스 내에 게시 또는 업로드한 모든 콘텐츠(텍스트, 이미지 등)의 저작권은
                해당 회원에게 있습니다.<br />
                2. 회원은 타인의 저작권, 초상권 등 제3자의 권리를 침해해서는 안 됩니다.<br />
                3. 회사는 법령 또는 약관 위반, 권리침해, 서비스 질서 유지를 위하여 게시물을 사전
                통지 없이 삭제 또는 제한할 수 있습니다.
                <br /><br />

                <b>제7조 (이용제한 및 책임의 한계)</b>
                <br />
                1. 회원이 본 약관을 위반하거나 서비스의 정상적 운영을 방해하는 경우, 회사는 해당
                회원의 서비스 이용을 제한할 수 있습니다.<br />
                2. 서비스 내 게시물 및 커뮤니케이션에 대한 책임은 해당 회원에게 있으며, 회사는 회원
                간 분쟁에 직접 개입하지 않습니다.<br />
                3. 회사는 불가항력, 회원의 귀책사유, 또는 기타 회사의 합리적 관리 범위를 벗어난
                사유로 인한 서비스 장애에 대하여 책임을 지지 않습니다.
                <br /><br />

                <b>제8조 (약관의 변경)</b>
                <br />
                1. 회사는 관련 법령, 서비스 운영 정책 변화에 따라 약관을 변경할 수 있으며, 변경 시
                사전 고지 후 적용합니다.<br />
                2. 변경된 약관에 동의하지 않는 경우, 회원은 서비스 이용을 중단하고 탈퇴할 수
                있습니다.
                <br /><br />
          ...
          >
            <div class="bg-white rounded-2xl shadow-2xl w-[90vw] max-w-md p-6">
              ...
              <div class="max-h-64 overflow-auto text-sm space-y-2">
                ...
                회사는 회원가입 및 서비스 제공을 위해 <b>이메일</b>(카카오/애플 소셜 로그인)만을
                수집합니다.<br />
                카메라·앨범 권한은 사진 첨부 및 게시물 작성, 알림 권한은 커뮤니티 알림 제공
                목적으로만 사용됩니다.
                <br /><br />
                ...
                - 단, 법령에 따라 보관이 필요한 정보는 해당 법률에서 정한 기간 동안 보유될 수
                있습니다.
                <br /><br />

                <b>4. 개인정보 국외 이전 안내</b><br />
                - 회원정보 및 서비스 운영 데이터는 Amazon Web Services(AWS) 북미(USA) 리전 서버에
                안전하게 보관·처리됩니다.<br />
                - 국외 이전 관련 보호 조치를 준수합니다.
                <br /><br />

                <b>5. 외부 서비스 연동</b><br />
                - 본 서비스는 카카오, 애플 소셜 로그인, Firebase(알림 서비스)와 연동되어 있으며, 각
                서비스 제공자의 정책에 따라 일부 정보가 연동·처리될 수 있습니다.
                <br /><br />

                <b>6. 회원의 권리와 행사방법</b><br />
                - 회원은 언제든지 개인정보 열람, 정정, 삭제, 처리정지, 동의 철회를 요청할 수
                있습니다.<br />
                - 서비스 내 설정 또는 <b>admin@raspyapp.com</b>을 통해 문의 가능합니다. <br /><br />

                <b>7. 개인정보 보호 책임자</b><br />
                - 책임자: 대표이사(주식회사 래스피)
                <br />
                - 연락처: <b>admin@raspyapp.com</b> <br /><br />
...
.loader {
  ...
  align-items: center;
  justify-content: center;
  animation: pop-in 0.23s cubic-bezier(0.47, 1.64, 0.41, 0.8);
}
.loading-text {
  font-size: 1.2rem;
