<template>
  <header class="fixed top-0 left-0 w-full bg-[#fff]  shadow z-50">
    <div class="max-w-4xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
      ...
      <div v-if="props.hasReferer==true" class="absolute left-1/2 transform -translate-x-1/2 text-black text-sm font-light">
        {{ props.title }}
      </div>
          ...
          <span v-if="hasAlert">
            <svg width="24" height="24" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_4418_4)">
                <path d="M10.75 5.5C12.1307 5.5 13.25 4.38071 13.25 3C13.25 1.61929 12.1307 0.5 10.75 0.5C9.36929 0.5 8.25 1.61929 8.25 3C8.25 4.38071 9.36929 5.5 10.75 5.5Z" fill=""/>
                ...
                <path d="M5 13.5H7" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
              </g>
              <defs>
