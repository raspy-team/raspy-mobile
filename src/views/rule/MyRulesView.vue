<template>
  ...
  >
    ...
    <h1 class="ml-3 text-lg font-bold text-gray-900">내 규칙</h1>
  </div>

  <!-- 필터 탭 -->
  <div class="mt-14 pt-4 px-4 bg-white sticky top-14 z-40 border-b border-gray-100">
  ...
  <!-- 규칙 목록 -->
  <div class="max-w-2xl mx-auto px-5 pt-6 pb-20">
  ...
  >
    <div class="bg-white p-6 m-5 rounded-2xl w-full max-w-sm shadow-2xl">
      <div class="text-center mb-4">
        ...
        <h3 class="text-lg font-bold text-gray-900 mb-2">수정 요청 취소</h3>
        <p class="text-sm text-gray-600">정말로 수정 요청을 취소하시겠습니까?</p>
      </div>
