      ...
      <div class="max-w-4xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
          ...
          >
            ...
            <span v-if="unreadCount > 0" class="absolute top-1 right-1 w-2 h-2 bg-orange-500 rounded-full"></span>
          </button>
      ...
      <transition name="slide">
        ...
        >
          <div class="flex items-center justify-between px-6 h-16 border-b">
            ...
            <button @click="toggleNotificationPanel" class="text-gray-400 hover:text-gray-800 text-xl">
          ...
          <div class="flex-1 overflow-y-auto">
            <template v-if="notifications.length > 0">
              <ul>
                ...
                >
                  <div class="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full bg-orange-50 mr-4">
