<template>
    <!-- 상단: 상대방 프로필/닉네임 고정 -->
     <div  class="fixed top-0 w-full h-[8dvh] raspy-top">
...
<div  style="height: calc( (var(--real-vh, 1vh) * 100))" class="pt-[8dvh] pb-[10dvh] px-1">
    <!-- 메시지 목록 -->
...
<div class="fixed bottom-0 w-full h-[10dvh] pb-[24px]">
    <!-- 입력창 -->
