<template>
  ...
  <div class="pb-8 max-w-xl mx-auto">
      ...
      <form @submit.prevent="createGame">
          ...
          <div class="space-y-6">
            ...
            <div class="mt-8">
              ...
              <div class="space-y-4">
                <div
                  class="flex items-center justify-between bg-white p-4 rounded-xl border border-gray-200"
                >
                  <div class="flex items-center">
                    <i class="fas fa-users text-orange-500 mr-3"></i>
                    <span class="text-sm text-gray-700">인원 제한</span>
                  </div>
                  <div class="flex items-center">
                    <span class="text-sm font-medium text-gray-700">1v1</span>
                  </div>
                </div> -->
              <!-- <div
                class="flex items-center justify-between bg-white p-4 rounded-xl border border-gray-200"
              >
                <div class="flex items-center">
                  ...
                  <span class="text-sm text-gray-700">Skill Level</span>
                </div>
                <button class="flex items-center">
                  <span class="text-sm text-gray-700 mr-2">All Levels</span>
              ...
              >
                <div class="flex items-center">
                  ...
                  <span class="text-sm text-gray-700">Privacy</span>
                </div>
                <button class="flex items-center">
                  <span class="text-sm text-gray-700 mr-2">Public</span>
                  <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                </button>
              </div>
            </div> -->
    ...
    <!-- 모달들 -->
    <RuleSelectModal v-if="showSelectModal" @select="selectRule" @close="showSelectModal = false; selectRule" />
