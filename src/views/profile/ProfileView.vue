...
<div class="rounded-xl bg-white w-full max-w-xl mx-auto shadow flex flex-col">
  <div class="grid grid-cols-4 border-b border-gray-200">
    ...
    <div class="flex flex-col items-center justify-center p-4">
      <span class="my-1">
        <!-- 승 SVG -->
        <svg width="24" height="24" viewBox="0 0 100 100"><path d="M39.7916 74.9999L16.0416 51.2499L21.9791 45.3124L39.7916 63.1249L78.0208 24.8958L83.9583 30.8333L39.7916 74.9999Z" fill="#4d4d4d"/></svg>
      </span>

      <span class="text-[1.6rem] font-[800] text-[#4d4d4d]">{{ user.stats.wins }}</span>
    ...
    <div class="flex flex-col items-center justify-center p-4">
      <span class="my-1">
        <svg width="24" height="24" viewBox="0 0 100 100"><path d="M8.33337 83.3334L50 16.6667L91.6667 83.3334H8.33337ZM23.3334 75.0001H76.6667L50 32.2917L23.3334 75.0001Z" fill="#4d4d4d"/></svg>
      </span>
      
      <span class="text-[1.6rem] font-[800] text-[#4d4d4d]">{{ user.stats.draws }}</span>
    ...
    <div class="flex flex-col items-center justify-center p-4">
      <span class="my-1">
        <svg width="24" height="24" viewBox="0 0 100 100"><path d="M26.6667 79.1666L20.8334 73.3333L44.1667 49.9999L20.8334 26.6666L26.6667 20.8333L50 44.1666L73.3334 20.8333L79.1667 26.6666L55.8334 49.9999L79.1667 73.3333L73.3334 79.1666L50 55.8333L26.6667 79.1666Z" fill="#4d4d4d"/></svg>
      </span>
          <span class="text-[1.6rem] font-[800] text-[#4d4d4d]">{{ user.stats.losses }}</span>
...
<transition name="champ-slide">
  <div
    v-if="showChampions"
    class="champ-card-container w-full max-w-md mx-auto mt-0"
  >
...
.champ-slide-enter-active, .champ-slide-leave-active {
...
.champ-card {
  ...
  box-shadow: 0 2px 18px 0 rgba(80,80,80,0.07), 0 1.5px 8px 0 rgba(230,130,60,0.09);
