<template>
  <div class="px-4 max-w-lg mx-auto space-y-6 py-6">
    <!-- Loading State -->
    ...
    <!-- Error State -->
    <div v-else-if="error" class="bg-red-900/20 border border-red-600 rounded-2xl p-6 text-center">
      ...
      <div v-if="rankings.length > 0" class="bg-gray-800 rounded-2xl shadow-lg p-6">
        ...
        <div v-else class="space-y-3 mb-4">
          <div
            ...
            :key="ranking.userId"
            @click="handleProfileClick(ranking.userId)"
        ...
        <div class="space-y-2">
          ...
          >
            <div class="w-8 text-center">
              <span
                :class="['font-bold', ranking.isCurrentUser ? 'text-orange-400' : 'text-gray-400']"
              >
                {{ ranking.rank }}
              </span>
            </div>
...
const emit = defineEmits(['retry', 'profile-click'])
