    ...
    >
      ...
      >
        ...
        <div class="flex flex-col gap-2 items-center mb-5 mt-1">
          ...
          <div class="text-xs text-gray-500 -mt-1">경기 기록을 확인해보세요</div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 text-center">
          ...
          >
            ...
            <span
              class="absolute left-1/2 top-[55%] transform -translate-x-1/2 -translate-y-1/2 text-[0.85rem] font-bold drop-shadow"
